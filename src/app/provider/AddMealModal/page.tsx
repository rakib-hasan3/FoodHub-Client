...
import { PlusCircle, Utensils, IndianRupee, Clock, Flame, Users, Info, Image as ImageIcon, CheckCircle2, ArrowLeft } from "lucide-react";
...
const AddMealPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (data.success) {
                toast.success("Meal added successfully to your menu!");
        ...
        <div className="min-h-screen bg-[#fafafa] dark:bg-black px-4 py-8 md:py-12 lg:py-16">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                    ...
                    {/* Left Column: Industry Standard Guidance */}
                    <div className="lg:col-span-5 space-y-10">
                        <div className="space-y-6">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 dark:text-white leading-[1.1] tracking-tight">
                                ...
                                List Your <span className="text-orange-500">Culinary</span> Masterpiece.
                            </h1>
                            <p className="text-lg text-gray-500 dark:text-gray-400 font-medium leading-relaxed max-w-md">
                                Follow our professional listing standards to ensure your meal gets the visibility it deserves. 
                            </p>
                        </div>
                        ...
                        <div className="space-y-8">
                            <div className="flex gap-5">
                                ...
                                <div>
                                    <h3 className="font-bold text-gray-900 dark:text-white text-lg">Visual Excellence</h3>
                                    <p className="text-sm text-gray-500 mt-1">High-resolution images increase order rates by up to 45%. Ensure your lighting is professional.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-5">
                                ...
                                <div>
                                    <h3 className="font-bold text-gray-900 dark:text-white text-lg">Detailed Descriptions</h3>
                                    <p className="text-sm text-gray-500 mt-1">Include key ingredients and unique preparation methods. Customers love knowing the story behind the dish.</p>
                                </div>
                            </div>

                            <div className="flex gap-5">
                                <div className="w-12 h-12 bg-green-500 rounded-2xl flex items-center justify-center shrink-0 shadow-lg shadow-green-500/20">
                                    <Clock className="w-6 h-6 text-white" />
                                </div>
                                <div>
                                    <h3 className="font-bold text-gray-900 dark:text-white text-lg">Precise Timing</h3>
                                    <p className="text-sm text-gray-500 mt-1">Setting accurate preparation times builds trust and ensures smooth delivery operations.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-8 bg-zinc-900 rounded-[2.5rem] border border-white/5 relative overflow-hidden group">
                            ...
                            <div className="relative z-10 flex flex-col gap-4">
                                ...
                                <h4 className="text-white font-bold">Industry Compliance</h4>
                                <p className="text-xs text-gray-400 leading-relaxed">
                                    All listings must adhere to local health and safety regulations. By submitting, you confirm the use of high-quality ingredients.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="bg-white dark:bg-zinc-900 border border-gray-100 dark:border-white/5 shadow-[0_30px_100px_-20px_rgba(0,0,0,0.05)] rounded-[2.5rem] overflow-hidden">
                            ...
                            <form className="p-8 md:p-12 space-y-12" onSubmit={handleSubmit}>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        <div className="space-y-3">
                                            ...
                                            <input
                                                ...
                                                placeholder="e.g. Wagyu Beef Risotto"
                                                className="w-full h-14 bg-gray-50/50 dark:bg-white/5 border-gray-100 dark:border-white/10 focus:bg-white dark:focus:bg-black focus:border-orange-500 focus:ring-4 focus:ring-orange-500/5 rounded-2xl px-6 transition-all outline-none text-gray-800 dark:text-white font-semibold border"
                                                required
                                            />
                                        </div>
                                        <div className="space-y-3">
                                ...
                                <div className="space-y-8 pt-8 border-t border-gray-100 dark:border-white/5">
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <input type="text" name="preparationTime" value={form.preparationTime} onChange={handleChange} placeholder="e.g. 20m" className="w-full h-12 bg-gray-50/50 dark:bg-white/5 border-gray-100 dark:border-white/10 rounded-xl px-4 text-sm font-bold border" />
                                        </div>
                                        <div className="space-y-2">
                                            <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1 flex items-center gap-1.5">
                                                <Flame className="w-3 h-3" /> Calorie Count
                                            </label>
                                            <input type="number" name="calories" value={form.calories} onChange={handleChange} placeholder="kcal" className="w-full h-12 bg-gray-50/50 dark:bg-white/5 border-gray-100 dark:border-white/10 rounded-xl px-4 text-sm font-bold border" />
                                        </div>
                                        <div className="space-y-2">
                                            <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1 flex items-center gap-1.5">
                                                <Users className="w-3 h-3" /> Serving Size
                                            </label>
                                            <input type="text" name="servingSize" value={form.servingSize} onChange={handleChange} placeholder="e.g. 1-2 Pers." className="w-full h-12 bg-gray-50/50 dark:bg-white/5 border-gray-100 dark:border-white/10 rounded-xl px-4 text-sm font-bold border" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <textarea
                                            ...
                                            onChange={handleChange}
                                            rows={2}
                                            placeholder="Fresh Truffles, Himalayan Salt, Virgin Olive Oil..."
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <textarea
                                            ...
                                            onChange={handleChange}
                                            rows={4}
                                            placeholder="Describe the aroma, texture and experience..."
                                            className="w-full p-5 bg-gray-50/50 dark:bg-white/5 border-gray-100 dark:border-white/10 focus:bg-white dark:focus:bg-black rounded-2xl transition-all outline-none text-sm font-semibold border resize-none leading-relaxed"
                                        />
                                    </div>
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full h-20 bg-orange-500 hover:bg-orange-600 text-white font-black text-xl rounded-[2rem] shadow-2xl shadow-orange-500/30 transition-all hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-4 disabled:bg-gray-200 disabled:shadow-none"
                                >
