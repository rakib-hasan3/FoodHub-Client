...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="flex min-h-screen bg-gray-50 dark:bg-zinc-950 transition-colors duration-300">
            ...
            {/* Sidebar Container */}
            <div
                className={`fixed z-50 top-0 left-0 h-screen w-72 bg-white dark:bg-zinc-900 border-r border-gray-100 dark:border-white/5 transition-transform duration-500 ease-in-out
            ...
            <div className="flex-1 md:ml-72 flex flex-col min-h-screen">
                ...
                {/* Header Area */}
                <header className="sticky top-0 z-30 flex items-center justify-between h-20 px-4 md:px-8 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border-b border-gray-100 dark:border-white/5">
                    ...
                    <div className="flex items-center gap-4 flex-1">
                        ...
                        <div className="hidden sm:flex items-center gap-3 px-4 py-2.5 rounded-2xl bg-gray-50 dark:bg-white/5 border border-transparent focus-within:border-orange-500/50 focus-within:bg-white dark:focus-within:bg-zinc-800 transition-all w-full max-w-md group">
                    ...
                    <div className="flex items-center gap-3 md:gap-4">
                        ...
                        <div className="flex items-center gap-3 pl-1 pr-1.5 py-1 rounded-full border border-gray-100 dark:border-white/10 bg-gray-50/50 dark:bg-white/5 hover:bg-gray-100 dark:hover:bg-white/10 transition-all cursor-pointer">
                            ...
                            <div className="hidden lg:block pr-2">
                                <p className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-tight">Admin User</p>
                                <p className="text-[10px] font-bold text-orange-500 uppercase">Super Admin</p>
                            </div>
                        </div>
                    </div>
                </header>
